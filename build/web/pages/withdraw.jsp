<%-- 
    Document   : withdraw
    Created on : 10-Feb-2020, 21:20:27
    Author     : JOSWAL
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="../Scripts/css/withdraw.css" rel="stylesheet" type="text/css"/>
        <title>Gofer</title>
    </head>
    ...
    <body>
        <div class="container-fluid errand">
            ...
            <jsp:include page="../WEB-INF/jspf/static_pages/user/withdraw.jsp"></jsp:include>           
        </div>
