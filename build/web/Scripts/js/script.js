...
$(document).ready(function () {
    ...
    $(".email-signup").hide();
    $("#register-box-link, #register-span").click(function () {
        $(".email-login").fadeOut(100);
        $(".email-signup").delay(100).fadeIn(100);
        $("#login-box-link, #login-span").removeClass("active");
        $("#register-box-link, #register-span").addClass("active");
    });
    $("#login-box-link, #login-span").click(function () {
        $(".email-login").delay(100).fadeIn(100);;
        $(".email-signup").fadeOut(100);
        $("#login-box-link, #login-span").addClass("active");
        $("#register-box-link, #register-span").removeClass("active");
    });
